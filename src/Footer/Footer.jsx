...
const Footer = () => {
    return (
                ...
                <div className="mx-auto w-full ">
                    ...
                    <div className="px-28  py-6 pt-9 border bg-black   md:flex md:items-center md:justify-between">
                        <span className="text-sm text-white  sm:text-center"><a href="https://flowbite.com/">Copyright</a> © 2023 - All Rights Reserved.
                        </span>
                        <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
                            ...
                            <a href="#" className="text-indigo-600 hover:text-gray-900 dark:hover:text-white">
                            ...
                            <a href="#" className="text-red-600 hover:text-gray-900 dark:hover:text-white">
                                <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
